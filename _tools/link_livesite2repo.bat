...
IF EXIST  %joomlasite_path%\administrator\components\com_flexicontent\manifest.xml  (del %joomlasite_path%\administrator\components\com_flexicontent\manifest.xml)
mklink %joomlasite_path%\administrator\components\com_flexicontent\manifest.xml  %repository_path%\manifest.xml
...
mklink %joomlasite_path%\language\en-GB\en-GB.com_flexicontent.ini  %repository_path%\site\language\en-GB.com_flexicontent.ini
...
mklink %joomlasite_path%\administrator\language\en-GB\en-GB.com_flexicontent.ini  %repository_path%\admin\language\en-GB.com_flexicontent.ini
...
mklink %joomlasite_path%\administrator\language\en-GB\en-GB.com_flexicontent.sys.ini  %repository_path%\admin\language\en-GB.com_flexicontent.sys.ini
